...
const modelsInfo = {
  Company: ["id", "name", "identifier", "country", "foundationDate", "createdAt", "updatedAt"]
};
const inputsInfo = {
  CompanyWhereInput: ["AND", "OR", "NOT", "id", "name", "identifier", "country", "foundationDate", "createdAt", "updatedAt"],
  CompanyOrderByInput: ["id", "name", "identifier", "country", "foundationDate", "createdAt", "updatedAt"],
  CompanyWhereUniqueInput: ["id"],
  CompanyScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "identifier", "country", "foundationDate", "createdAt", "updatedAt"],
  CompanyCreateInput: ["name", "identifier", "country", "foundationDate", "createdAt", "updatedAt"],
  CompanyUpdateInput: ["name", "identifier", "country", "foundationDate", "createdAt", "updatedAt"],
  CompanyUpdateManyMutationInput: ["name", "identifier", "country", "foundationDate", "createdAt", "updatedAt"],
...
const outputsInfo = {
  ...
  CompanyGroupBy: ["id", "name", "identifier", "country", "foundationDate", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  CompanyCountAggregate: ["id", "name", "identifier", "country", "foundationDate", "createdAt", "updatedAt", "_all"],
  CompanyAvgAggregate: ["id"],
  CompanySumAggregate: ["id"],
  CompanyMinAggregate: ["id", "name", "identifier", "country", "foundationDate", "createdAt", "updatedAt"],
  CompanyMaxAggregate: ["id", "name", "identifier", "country", "foundationDate", "createdAt", "updatedAt"]
};
const argsInfo = {
